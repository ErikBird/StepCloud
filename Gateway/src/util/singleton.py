class Singleton:
    """
    Taken from: https://github.com/FlavienVernier/pyeventbus/blob/master/pyeventbus3/Singleton.py
    ...
    def __call__(self):
        raise TypeError('Singletons must be accessed through `EventBus.Instance()`.')
