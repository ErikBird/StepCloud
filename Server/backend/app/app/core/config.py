...
class Settings(BaseSettings):
    ...
    GATEWAY_API_V1_STR: str = "/gateway/api/v1"
    SECRET_KEY: str = secrets.token_urlsafe(32)
    # 60 minutes * 24 hours * 8 days = 8 days
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 60 * 24 * 8
    # 60 minutes * 24 hours * 365 days * 10 years = 5 years
    REFRESH_TOKEN_EXPIRE_MINUTES: int = 60 * 24 * 365 * 5
    SERVER_NAME: str
    ...
    POSTGRES_DB: str
    TEST_DATABASE_URI_ASYNC: str = "sqlite+aiosqlite:///:memory:"
    ...
    EMAIL_TEST_USER = "testaccount@erikschwan.de"  # type: ignore
    FIRST_SUPERUSER: EmailStr
    UUID_TEST_GATEWAY = "0000.0000.0000.0000"
